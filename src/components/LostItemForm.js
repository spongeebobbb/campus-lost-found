...
const LostItemForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const lostItemData = {
        ...
        status: 'searching', // searching, found, returned
      ...
      if (image) {
        ...
        const storageRef = ref(storage, `lost-items/${Date.now()}-${image.name}`);
        ...
        uploadTask.on('state_changed',
          ...
          async () => {
            ...
            try {
              ...
              // Add image URL to lost item data
              lostItemData.imageURL = downloadURL;
      ...
      setError('Failed to report lost item: ' + error.message);
      setLoading(false);
      setFormSubmitted(false);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-center text-[#82001A]">Report Lost Item</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            required
            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[#82001A] focus:border-[#82001A]"
            placeholder="Provide details about the item (color, brand, identifiable features, etc.)"
            value={description}
        ...
        <div>
          ...
          <div className="mt-1 relative rounded-md shadow-sm">
            ...
            <input
              type="number"
              id="reward"
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 pl-7 pr-3 focus:outline-none focus:ring-[#82001A] focus:border-[#82001A]"
              placeholder="0.00"
              step="0.01"
              min="0"
              value={reward}
